 ...
 * generated in the com.javacodegeeks.enterprise.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _PrintMessage_QNAME = new QName("http://ws.enterprise.javacodegeeks.com/", "printMessage");
    private final static QName _PrintMessageResponse_QNAME = new QName("http://ws.enterprise.javacodegeeks.com/", "printMessageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.javacodegeeks.enterprise.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.enterprise.javacodegeeks.com/", name = "printMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.enterprise.javacodegeeks.com/", name = "printMessageResponse")
